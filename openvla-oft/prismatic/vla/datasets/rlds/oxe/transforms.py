...
def rlbench_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    """RLBench converter already emits standardized 7D actions and language."""
    return trajectory
...
for _task in _RLBENCH_TASKS:
    OXE_STANDARDIZATION_TRANSFORMS[f"rlbench_{_task}"] = rlbench_dataset_transform
del _task
